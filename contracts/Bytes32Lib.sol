...
library Bytes32Lib {
  ...
  function getByte(bytes32 data, uint256 position) internal returns(uint256) {
  ...
  function getBytes2(bytes32 data, uint256 position) internal returns(uint256) {
  ...
  function getBytes4(bytes32 data, uint256 position) internal returns(uint256) {
  ...
  function getLastCompleted(bytes32 data) internal returns(uint256) {
    return data.getBytes4(LAST_COMPLETED);
  }

  function setLastCompleted(bytes32 data, uint256 lastCompleted) internal returns(bytes32) {
